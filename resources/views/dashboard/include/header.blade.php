...
<img class="avatar img-thumbnail rounded-circle shadow" src="{{url('/')}}/assets/img/profile_av.png" alt="">
</a>
<div class="dropdown-menu border-0 rounded-4 shadow p-0">
<div class="card border-0 w240">
<div class="card-body border-bottom d-flex">
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/profile_av.png" alt="">
<div class="flex-fill ms-3">
